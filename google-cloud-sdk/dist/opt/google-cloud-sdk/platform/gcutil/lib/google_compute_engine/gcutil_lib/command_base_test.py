...
class OldCommandBaseTest(unittest.TestCase):
  ...
  def testOperationPrintSpec(self):
    ...
    self.assertEqual(
        set([('region', 'region')]),
        set(spec.field_mappings) ^ set(spec_v1beta15.field_mappings))
  ...
  def testOperationPrintSpecVersions(self):
    ...
    command = MockCommand('mock_command', flag_values)
    command.supported_versions = ['v1beta15']

    command.SetFlags(flag_values)
    command.api = old_mock_api.CreateMockApi()

    command.api.version = version.v1beta15
    self.assertTrue(
  ...
  def _DoTestGetScopeFromSelfLink(self, api_version):
    ...
    tests = (
        (base + 'v1beta15/projects/my-project/global/networks/net',
         ('global', '')),

        (base + 'v1beta15/projects/my-project/zones/zone1/instances/inst',
         ('zones', 'zone1')),

        (base + 'v1beta15/projects/my-project/zones/zone2',
         ('zones', 'zone2')),
        ...
        # missing projects
        (base + 'v1beta15/global/networks/net',
         (None, None)),

        # missing project
        (base + 'v1beta15/projects/global/networks/network',
         (None, None)),
