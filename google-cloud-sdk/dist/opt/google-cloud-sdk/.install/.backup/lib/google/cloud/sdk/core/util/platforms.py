...
class OperatingSystem(object):
  ...
  _OPERATING_SYSTEM_TUPLE = collections.namedtuple('OperatingSystemTuple',
                                                   ['id', 'name'])
  WINDOWS = _OPERATING_SYSTEM_TUPLE('WINDOWS', 'Windows')
  MACOSX = _OPERATING_SYSTEM_TUPLE('MACOSX', 'Mac OS X')
  LINUX = _OPERATING_SYSTEM_TUPLE('LINUX', 'Linux')
  CYGWIN = _OPERATING_SYSTEM_TUPLE('CYGWIN', 'Cygwin')
  MSYS = _OPERATING_SYSTEM_TUPLE('MSYS', 'Msys')
