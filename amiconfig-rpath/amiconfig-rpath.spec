...
ln -s /usr/lib/python/site-packages/amiconfig %{buildroot}/usr/lib/python2.7/site-packages/amiconfig
...
/usr/lib/python2.7/site-packages/amiconfig
%{_sbindir}/amiconfig
%{_sysconfdir}/amiconfig/default.cfg

%changelog
* Fri Nov 13 2015 Jakob Blomer <jblomer@cern.ch> - 0.5.2
- Fit for CentOS 7
