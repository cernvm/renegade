...
$(SPEC_FILE): version release $(CPAN_TARBALL) | $(RPMTOP)/SPECS
	cpan2rpm --name=$(NAME) --no-prfx --version=$(VERSION) --release=$(RELEASE).$(DISTTAG) --buildarch=$(ARCH) --spec-only --spec=$(SPEC_FILE) --make-maker="INSTALLDIRS=vendor" $(CPAN2RPM_EXTRA_OPTIONS) $(CPAN_TARBALL)
